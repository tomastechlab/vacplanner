 ...
 */
final class Version20251223151135 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE item_list_user (item_list_id INT NOT NULL, user_id INT NOT NULL, PRIMARY KEY(item_list_id, user_id))');
        $this->addSql('CREATE INDEX IDX_C4871F5036F330DF ON item_list_user (item_list_id)');
        $this->addSql('CREATE INDEX IDX_C4871F50A76ED395 ON item_list_user (user_id)');
        ...
        $this->addSql('ALTER TABLE item_list_user ADD CONSTRAINT FK_C4871F5036F330DF FOREIGN KEY (item_list_id) REFERENCES item_list (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE item_list_user ADD CONSTRAINT FK_C4871F50A76ED395 FOREIGN KEY (user_id) REFERENCES "user" (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE item_list_user DROP CONSTRAINT FK_C4871F5036F330DF');
        $this->addSql('ALTER TABLE item_list_user DROP CONSTRAINT FK_C4871F50A76ED395');
        ...
        $this->addSql('DROP TABLE item_list_user');
